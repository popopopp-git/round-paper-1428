...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-paper-1428)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/round-paper-1428
```

A live public deployment of this template is available at [https://round-paper-1428.templates.workers.dev](https://round-paper-1428.templates.workers.dev)
